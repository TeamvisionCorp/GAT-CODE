...
public class TestCaseTest 
{
  ...
  {
//	  TestStepModule case2=new TestStepModule();
//	  case2.ID="nihao2";
//	  case2.Name="nihao2";
//	  InterfaceTestStep step=new InterfaceTestStep();
//	  step.StepName="nihao";	  
//	  step.StepParameterID="fdsfsd";
//	  case2.Steps.add(step);
//	  
//	  TestStepModule case1=new TestStepModule();
//	  case1.ID="nihao";
//	  case1.Name="nihao";
//	  InterfaceTestStep step1=new InterfaceTestStep();
//	  step1.StepName="nihao";	  
//	  step1.StepParameterID="fdsfsd";
//	  case1.Steps.add(step1);
//	  case1.StepSet=case2;
...
//	  case12= (InterfaceStepsCase)XMLSerializer.XMLToObject(case12,caseXML);
//	  
